...
export class DecisionService {
    ...
    demurrage;
    risk;
    constructor(data, demurrage, risk) {
        this.data = data;
    ...
    evaluateInternal(input, suggestAlternatives) {
        ...
        return {
            ...
            honestyNote: "Rupees use published carrier tariffs (2023–2024 notices). Dwell uses Port Sense model on historical port data — not live AIS.",
        };
    }
    cheapestAlternative(input) {
        const base = {
            carrierId: input.carrierId,
        ...
        const ranked = this.comparePorts(base).filter((r) => r.portId !== input.portId);
        const best = ranked[0];
