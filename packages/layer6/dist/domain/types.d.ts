...
export type InlandId = "IN_SURAT" | "IN_AHMEDABAD" | "IN_PUNE" | "IN_DELHI" | "IN_HYD" | "IN_BLR";
...
export declare const INLAND_IDS: readonly InlandId[];
export declare function isInlandId(raw: string): raw is InlandId;
