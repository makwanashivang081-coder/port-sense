export type { FileFormat, CanonicalField, ValidationStatus, RawArtifact, TabularDataset, FieldMapping, ProvenanceRecord, NormalizedValue, RecordCandidate, IngestionBatchResult, } from "./domain/types.js";
...
export { toLayer2IngestionResult, summarizeBridge, type Layer2IngestionResult, } from "./application/bridge-to-layer2.js";
export { getLayer1Root, getLayer1Status, type Layer1StatusSummary, } from "./infrastructure/status.js";
