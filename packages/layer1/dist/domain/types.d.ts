...
export type CanonicalField = "port_name" | "observation_date" | "waiting_time" | "vessel_count" | "free_days" | "distance" | "currency" | "unknown";
export type ValidationStatus = "VALID" | "INVALID" | "SUSPICIOUS" | "DUPLICATE" | "REJECTED_BATCH";
...
export declare const TRANSFORMATION_VERSION = "layer1-ingest-v1.0.0";
